...
# Manually set IOC_STARTUP_DIR if cpsc.sh will reside somewhere other than softioc
#!IOC_STARTUP_DIR=/home/username/epics/ioc/synApps/cpsc/iocBoot/ioccpsc/softioc

# Manually set IOC_COMMAND_DIR if cpsc.sh will reside somewhere other than softioc
#!IOC_COMMAND_DIR=/home/username/epics/ioc/synApps/cpsc/iocBoot/ioccpsc/softioc/commands
...
#!IOC_BIN_DIR=/home/username/epics/synApps/support/cpsc/bin
...
checkpid() {
    MY_UID=`${ID} -u`
    # The '\$' is needed in the pgrep pattern to select cpsc, but not cpsc.sh
