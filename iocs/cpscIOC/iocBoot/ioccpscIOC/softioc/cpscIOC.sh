...
# Manually set IOC_STARTUP_DIR if cpscIOC.sh will reside somewhere other than softioc
#!IOC_STARTUP_DIR=/home/username/epics/ioc/synApps/cpscIOC/iocBoot/ioccpscIOC/softioc

# Manually set IOC_COMMAND_DIR if cpscIOC.sh will reside somewhere other than softioc
#!IOC_COMMAND_DIR=/home/username/epics/ioc/synApps/cpscIOC/iocBoot/ioccpscIOC/softioc/commands
...
#!IOC_BIN_DIR=/home/username/epics/synApps/support/cpscIOC/bin
...
checkpid() {
    MY_UID=`${ID} -u`
    # The '\$' is needed in the pgrep pattern to select cpscIOC, but not cpscIOC.sh
